  ...
  <div id="content">
	  ...
	  <webbase:errorData dataType='ErrorURL' nextURL='/jsp/SetAdbaseImage.jsp'/>  
          ...
          <div class="container">
            ...
            Your selected Ad Category is:  <span class="mgroupname"> <strong>
			...
			<webbase:uploadImage dataType="uploadBrowseButton" label="Select Image" fieldSize="50"/>
                        ...
                        <webbase:uploadImage dataType="uploadImageButton" label="Upload Image Selected" maxImageSize="1000000" validImageFormats="JPEG"> 
