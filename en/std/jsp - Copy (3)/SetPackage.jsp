			...
			<div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7">
                            <div id="pckDisplay">
                                <webbase:orderData dataType="PackageSelectorV2" packageDisplayOptions="description:image" editMode="1" numColumns="3" buttonClass="btn btn-default" label="Choose Package" nextURL="/jsp/SetMerchandiseAttributes.jsp" />
