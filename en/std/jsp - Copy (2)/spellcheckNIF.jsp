  ...
  <tr>
	...
	<td width="600" valign="top"><!-- InstanceBeginEditable name="content" -->
	  <script language="javascript" src="../../../scripts/spellcheckNIF.js"></script>
          ...
          <tr> 
            <td align="center" width="50%"><webbase:formHelper dataType="cancelButton" label="Back" name="GoBack" nextURL="/jsp/composeandschedule.jsp"> 
            ...
            <td align="center" width="50%"><img src="../../../images/spacer.gif" width="1" height="10"> 
              <webbase:formHelper dataType="submitButton" label="Continue" nextURL="/jsp/composeandschedule.jsp"> 
