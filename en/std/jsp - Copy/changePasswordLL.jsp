...
<table width="750" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><!-- InstanceBeginEditable name="content" -->
	  <span class="PageName"> !! -- changePasswordLL.jsp</span>
      <form name="login" method="post" action="WebBaseMain.do">
	    <table width="400" border="0" align="center" cellpadding="2" cellspacing="0"> 
                <tr align="center">
                  ...
                  <webbase:errorData dataType='ErrorURL' nextURL='/jsp/changePasswordLL.jsp'/></td>
          </tr>
                <tr>
                ...
                <tr> 
                  <td>&nbsp; </td> 
                  <td width="111"> 
                      <webbase:formHelper dataType="CancelNewCustomerBtn" label="Cancel Customer" nextURL="/jsp/ReviewOrder.jsp"> 
                    	<img src="../../../images/navigation/ignore.gif" width="80" height="17" border="0"> 
                      </webbase:formHelper> 
                  </td> 
                  <td width="150">
                    <webbase:formHelper dataType="SaveNewCustomerBtn" label="Save Customer" nextURL="/jsp/ReviewOrder.jsp"> 
