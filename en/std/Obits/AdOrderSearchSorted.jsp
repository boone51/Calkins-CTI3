    ...
    <td><!-- InstanceBeginEditable name="content" -->  
      <form method="post" action="WebBaseMain.do" name="OrderSearch"> 
        ...
        <table width="400" border="0" align="center" cellpadding="2" cellspacing="0" class="navborder"> 
          ...
          <tr class="bgcolor"> 
            <td align="right" class="mattrlabelcell">Invoice Text:</td> 
      ...
      <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="navborder"> 
        ...
        <tr>
	  <!-- Include a page that will display the user requested query results -->  
          <td class="mgroupheadercell">
		  <iframe src="UserQueryOrderResultsSorted.jsp" name="UserQueryOrderResultsSorted" id="UserQueryOrderResultsSorted" width="580" height="150" scrolling="auto" frameborder="0" marginwidth="0" marginheight="0"></iframe>
	  </td>
        </tr>
	<tr> 
          <td class="mgroupheadercell">&nbsp;</td> 
