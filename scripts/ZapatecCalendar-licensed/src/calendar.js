...
if(this.closeButton){var aCloseText = Zapatec.Calendar.i18n("CLOSE_ICON");hh(aCloseText, 1, 200,"Close").ttip = Zapatec.Calendar.i18n("CLOSE");}else{hd(row,1,"Close");}}else{hd(row,1,"Close");}
