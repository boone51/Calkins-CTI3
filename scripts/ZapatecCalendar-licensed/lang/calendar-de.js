...
// Track 40338 - new calendar version to support IE7 - retrofit of modifications made to original calendar
// Modification so that we can put text instead of the 'x' as the close icon
// because the 'x' doesnt really mean anything to anyone
// Language translation done via Babelfish - sorry if it incorrect
Zapatec.Calendar._TT["CLOSE_ICON"] = "Treffen Sie zu";
Zapatec.Calendar._TT["CLOSE"] = "Wenden Sie Daten an und schlie\u00dfen Sie";
