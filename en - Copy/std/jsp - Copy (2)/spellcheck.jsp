...
<table width="750" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td width="600" valign="top"><!-- InstanceBeginEditable name="content" --> 
      <span class="PageName"> !! -- SpellCheck.jsp</span>
      ...
      <form name="SpellCheck" method="post" action="WebBaseMain.do"> 
        <table width="450" border="0" align="center" cellpadding="0" cellspacing="0" > 
          ...
          <tr> 
            <td colspan="2" class="heading" >Spell Check - JSP </td> 
          </tr>
          <tr align="center">
            <td colspan="2">&nbsp;</td>
          </tr>
          <tr align="center"> 
            <td height="30" colspan="2">Your selected Ad Category is:<br> 
              ...
              <span class="mgroupname"><webbase:adData dataType='AdCategory' showCategoryName='false' showCategoryDescription='true' categoryTextSeparator=':'/></span>               </td> 
          </tr> 
          <tr>
            <td colspan="2" align="center">&nbsp;</td>
          </tr>
          ...
          <tr align="center"> 
            <td colspan="2">
              <webbase:spellCheck dataType="SpellText" width="400" depth="100"> 
                            ...
                            Click <a href="spellcheckNIF.jsp">here</a> for form
                            that doesn't use inline frames.                            </webbase:spellCheck> </td>
          </tr> 
          <tr>
            <td colspan="2">&nbsp;</td>
          </tr>
          <tr> 
            <td colspan="2" class="mgroupname">Correction</td>
          </tr> 
          <tr>
            <td colspan="2" align="center"><webbase:spellCheck dataType="Correction" width="32"/></td>
          </tr>
          <tr>
            <td colspan="2" class="mgroupname">Suggestions</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" align="center"><webbase:spellCheck dataType="ReplaceButton" buttonLabel="Replace"> 
                      ...
                      <img src="../../../images/navigation/replaceall.gif" alt="Replace All" width="80" height="17" border="0">                      </webbase:spellCheck> 
                      <webbase:spellCheck dataType="IgnoreButton" buttonLabel="Ignore"> 
                      <img src="../../../images/navigation/ignore.gif" alt="Ignore" width="80" height="17" border="0">                      </webbase:spellCheck> 
                      <webbase:spellCheck dataType="IgnoreAllButton" buttonLabel="IgnoreAll"> 
                      <img src="../../../images/navigation/ignoreall.gif" alt="Ignore All" width="80" height="17" border="0">                      </webbase:spellCheck> 
                      <webbase:spellCheck dataType="ResetButton" buttonLabel="Reset"> 
                      <img src="../../../images/navigation/reset.gif" alt="Reset" width="80" height="17" border="0">                      </webbase:spellCheck> </td>
          </tr>
          <tr>
            <td colspan="2" align="center">&nbsp;</td>
          </tr>
          ...
          <tr> 
            <td align="center" width="50%"><webbase:formHelper dataType="cancelButton" label="Back" name="GoBack" nextURL="/jsp/AllOnePage.jsp"> 
            ...
            <td align="center" width="50%"><img src="../../../images/spacer.gif" width="1" height="10"> 
              ...
              <img src="../../../images/navigation/continue.gif" width="70" height="17">              </webbase:formHelper></td> 
          </tr> 
          <tr> 
