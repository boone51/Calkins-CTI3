				...
				<div class="panel-body">
							<div class="row" style="padding:10px;">
								...
								<!--BEGIN dynamic content-->
											...
											<% if ((pageName.equals("SetMerchandiseAttributes.jsp")) || (pageName.equals("AnswerQuestions.jsp")) || (pageName.equals("GetPackageInformation.jsp")))  { %>
											 <li> Category: <webbase:adData dataType='AdCategory' showCategoryName='false' showCategoryDescription='true' categoryTextSeparator=':'/>  </li>
											<li>Package: <a href="#" data-toggle="modal" data-target=".changePackage"><webbase:orderData dataType="CurrentPackage" packageDisplayOptions="name" /></a></li>
											<%}%>
											...
											<% if ((pageName.equals("PreviewAds.jsp")) || (pageName.equals("EditAd.jsp")) || (pageName.equals("ReviewOrder.jsp")) || (pageName.equals("OrderConfirmationQuote.jsp")))  { %>
											 <li> Category: <webbase:adData dataType='AdCategory' showCategoryName='false' showCategoryDescription='true' categoryTextSeparator=':'/>  </li>
											<li>Package: <webbase:orderData dataType="CurrentPackage" packageDisplayOptions="name" /></li>
											<li>Ad Schedule(s): 
													<webbase:adIt>
