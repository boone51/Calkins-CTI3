						...
						<!--END Ad Gen Template Questions-->
							<div class="row text-center">
										...
										<!--We DO allow photos in this ad-->
														  ...
														  <!-- if a photo has not been uploaded yet -->
										<webbase:showIf expression="!isOnlinePhotoUploaded">
										<button type="button" class="btn btn-primary btn-lg" onClick="uploadPhotos('editAd')">CLICK HERE TO UPLOAD HOUSE PHOTOS</button>
										</webbase:showIf>
										<!-- if online photos were uploaded, display photos -->
										<webbase:showIf expression="isOnlinePhotoUploaded">
										<a href="#submitForm" class="grayButton" onClick="uploadPhotos('editAd')">CLICK HERE TO CHANGE PHOTOS</a>
...
<div class="row" style="padding-top:30px">
	...
	<div class="col-md-4 text-center">   
		<div id="previousBUT">
		<webbase:formHelper dataType="cancelButtonV2" label="Previous" nextURL="/jsp/SetMerchandiseAttributes.jsp" buttonClass="btn btn-default prevBUT"/>
...
<!--END webbase tag-->
				...
				<webbase:showIf expression="!anyPackageUserInputRequired">
				<webbase:formHelper dataType="submitButtonV2" name="ContinueButton" label="Continue" nextURL="/jsp/PreviewAds.jsp" buttonClass="btn btn-success">
