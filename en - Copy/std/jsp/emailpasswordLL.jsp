...
<% session.putValue( "pageName", "emailpasswordLL.jsp" );%>
<% session.putValue( "returnPage", "emailpasswordLL.jsp" );%>
<%@ include file="header.jsp"%>
	  ...
	  <form method="post" action="WebBaseMain.do" name="EmailPassword"> 
        <<webbase:errorData dataType='ErrorMsg'/>
                    <webbase:errorData dataType='ErrorURL' nextURL='/jsp/emailpasswordLL.jsp'/>
                <div class="container">
